...
const Hero = () => {
  ...
  return (
    <div
      id="home"
      className="relative flex flex-col justify-center items-center w-full px-4 sm:px-20 xl:px-32 min-h-screen bg-[#0A0A0F] overflow-hidden pt-20"
    >
      ...
      <div className="relative z-10 text-center mb-12 max-w-5xl">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-white/10 mb-8 hover:bg-white/10 transition-all duration-300 animate-bounceIn">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold leading-[1.1] mb-6 tracking-tight animate-slideUp animation-delay-100">
        ...
        <p className="mt-6 max-w-2xl mx-auto text-gray-400 text-base sm:text-lg leading-relaxed animate-fadeIn animation-delay-300">
      ...
      {/* CTA Buttons */}
      <div className="relative z-10 flex flex-wrap justify-center gap-4 text-sm sm:text-base mb-16 animate-scaleIn animation-delay-400">
        <button
          onClick={() => navigate("/ai")}
          ...
          transition-all duration-500 transform hover:scale-110 font-semibold animate-pulseGlow"
        >
      ...
      {/* Stats Section */}
      <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12 animate-slideUp animation-delay-500">
        {/* Stat 1 */}
        <div className="flex flex-col items-center hover:scale-110 transition-transform duration-500">
          <div className="flex items-center gap-2 px-6 py-3 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:bg-white/10 hover:border-purple-500/30 transition-all duration-500 hover-lift">
