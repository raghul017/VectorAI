      ...
      <div className="relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-purple-500/20 border border-purple-400/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
          ...
          animate-slideUp animation-delay-200 hover-lift"
          >
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 rounded-2xl bg-indigo-500/20 border border-indigo-400/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {AiToolsData.map((tool, index) => {
            const delay = `animation-delay-${Math.min(index * 100, 1000)}`;
            return (
              <div
                key={index}
                className={`group relative p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 
              hover:bg-white/10 hover:border-purple-500/30 transition-all duration-500 cursor-pointer
              hover:shadow-[0_0_30px_rgba(168,85,247,0.2)] hover-lift animate-scaleIn ${delay}`}
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  />
                  <ArrowRight className="w-5 h-5 text-gray-500 group-hover:text-purple-400 group-hover:translate-x-1 transition-all duration-300" />
                </div>
        ...
        {/* CTA Section */}
        <div className="mt-20 text-center animate-bounceIn animation-delay-600">
          <button
            ...
            transition-all duration-500 transform hover:scale-105 animate-pulseGlow"
          >
